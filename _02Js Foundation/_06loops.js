...
6. Write a `for` loop that lists all the cities in the
   array `["Paris", "New York", "Tokyo", "London"]`
...
//   Each iteration:
//    creates a new myCity
//    previous myCity is destroyed
//    no reassignment occurs in the same scope 
  const myCity = cities[i]; //Each loop iteration has a new block scope
  cityList[i] = myCity;
}
